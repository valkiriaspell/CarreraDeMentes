...
export default function FormAddQuestions() {
	...
	const textMail =
		'Gracias por enviarnos una nueva pregunta para el repertorio de ZooPer Trivia! Luego de pasar por revisión te avisaremos si fue aceptada. Saludos!';
	//////////  ---->    Local states data   <------ //////////////
	...
	if (user.guest) {
		Swal.fire({
			icon: 'error',
			title: 'Debes tener una cuenta para crear preguntas',
	...
	const onSubmit = async (e) => {
		e.preventDefault();
		//////////////// ---->    NO EMPTY ANSWERS   <------ /////////////
		!question || !answer || !false1 || !false2 || !false3 || !image
			? setErrorTotal('Completar formulario')
			: setErrorTotal('');
				...
				<div className='form'>
					...
					<form onSubmit={onSubmit}>
						...
						<div className='formName'>
							...
							<div>
								<input
									className={errorQuestion !== '' ? 'danger' : 'inputName'}
									name='question'
									type='text'
									value={question}
								...
								/>
								{errorQuestion ? (
									<p className='error'>{errorQuestion}</p>
								) : null}
							</div>
						</div>
						<div>
						...
						<div className='formMail'>
							...
							<div>
								<input
									className={errorAnswer !== '' ? 'danger' : 'inputEmail'}
									name='answer'
									type='text'
									value={answer}
									onChange={(e) => validation(e)}
						...
						<div className='FormSubmit'>
							<div className='checkbox'>
								...
								<label>
									...
									<button onClick={(e) => conditions(e)}>condiciones</button>
								</label>
							</div>
							<div className='terminos'>
								<ul>
									<li>
										{' '}
										Recomendamos verificar la veracidad de la respuesta enviada
										como "correcta".
									</li>
									<li> No se permiten palabras ofensivas.</li>
									<li>
										{' '}
										El incumplimiento de lo anterior podría incurrir en la
										sanción de su cuenta
									</li>
								</ul>
							</div>
							<input
